...
import 'package:flutter_web_signin/buttons/B2ButtonSettng.dart';
...
class B2Screen extends StatefulWidget {
  ...
  B2Screen({Key key, this.listPrintingItem});
  final List<PrintingItem> listPrintingItem;

  @override
  _B2ScreenState createState() => _B2ScreenState();
}
...
Future  _initCanvas() async{ 
  ...
  return Future.delayed(Duration(milliseconds: milliseconds),(){
    _myCanvas = new MyCanvas(widget.listPrintingItem, 
           (B2_WIDTH - (INDENT_LEFT_RIGHT*2)), (B2_HEIGHT - (INDENT_BOTTOM+INDENT_TOP)));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     key: _scaffoldstate,
      body:
      !_canvasChecked ?  loadingWidget :  Container(
      ...
      floatingActionButton: Column(
        ...
        children: <Widget>[
        B2ActionButtonSetting(listPrintingItem: widget.listPrintingItem),
        SizedBox(height: 8.0,),
  ...
  Widget _buildB2Widget(){
    ...
    return Container(
      ...
      child: Column(children: <Widget>[
        Row(children: <Widget>[
          Text('B2 ' + '(' + (B2_WIDTH-INDENT_BOTTOM*2).toString() + ' x ' +  (B2_HEIGHT-INDENT_BOTTOM*2).toString() + ')',
            style: TextStyle(
            fontSize: 16,
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTapDown: (TapDownDetails details){
                    ...
                    int dy = ((B2_HEIGHT -20) - details.localPosition.dy) ~/1;
